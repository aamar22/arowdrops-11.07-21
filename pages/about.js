        ...
        <div className="team">
            ...
            <div className="teamrow">
                <div className="team-member">
                    <div className="team-member-img1"></div>
                    <h2 className="h2 ct hrm dmt fwbb">Syed Anees</h2>
                    <p className="h3 ct hrm dmbd fwb">Cheif Executive Officer</p>
                    <div className="team-social fd">
                        <a href=""><div className="fb-team"></div>
                        </a>
                        <a href=""><div className="linkin-team"></div>
                        </a>
                        <a href="mailto:dennis@arowdrops.in"><div className="mail-team"></div>
                        </a>
                    </div>
                    <p className="p team-descrp">Having an experience of more than 28 years in the field of Fabrication of equipment with exotic material. With his extensive experience in the fabrication technology he would be contributing to the controls on Production, Planning and Control, Sub-contracting and Stores at Arowdrops.</p>
                </div>
                <div className="team-member">
                    <div className="team-member-img2"></div>
                    <h2 className="h2 ct hrm dmt fwbb">A.Dennis Thomson</h2>
                    <p className="h3 ct hrm dmbd fwb">Chief Marketing Officer</p>
                    <div className="team-social fd">
                        <a href=""><div className="fb-team"></div>
                        </a>
                        <a href=""><div className="linkin-team"></div>
